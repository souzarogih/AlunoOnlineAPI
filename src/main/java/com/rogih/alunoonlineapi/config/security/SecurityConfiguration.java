package com.rogih.alunoonlineapi.config.security;
...
//                        .requestMatchers("/auth/**").permitAll()  // Permitir acesso aos endpoints de autenticação
                                .requestMatchers("/auth/signin").permitAll()  // Permitir acesso aos endpoints de login
                                .requestMatchers("/auth/signup").permitAll()  // Permitir acesso aos endpoints de login
